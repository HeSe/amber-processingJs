...
smalltalk.addClass('ProcessingClock', smalltalk.PjsSketch, ['processing', 'centerX', 'centerY', 'maxArmLength'], 'Processing-Examples');
smalltalk.addMethod(
"_draw",
smalltalk.method({
selector: "draw",
...
var minutesPosition;
var secondsPosition;
smalltalk.send(self["@processing"],"_background_",[(224)]);
...
return self},
args: [],
source: "initialize\x0a\x0a\x09super initialize.\x0a\x0acenterX := processing width / 2.\x0acenterY := processing height / 2.\x0amaxArmLength := Math min: centerX or: centerY.",
